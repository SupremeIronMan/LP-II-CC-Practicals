...
- `server` - Node.js, Express, MongoDB (Mongoose), Task CRUD API
- `client` - React (Vite), Axios UI for add/list/delete tasks
...
2. Install dependencies:
   - `npm install`
3. Create `.env` if not present and paste your credentials
...
API_BASE_URL to "http:<public_ip>:SERVER_PORT(5000)/api"
